...
def main(filename):
    ...
    # Read in data
    lat,lon,edisp,ndisp,udisp,esig,nsig,usig = np.loadtxt(filename,skiprows=1,usecols=(1,2,3,4,5,6,7,8),unpack=True)

    # Return Parameters
    return sta,lat,lon,edisp,ndisp,udisp,esig,nsig,usig
